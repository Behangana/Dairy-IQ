...
Repository: **https://github.com/Behangana/Diary_IQ**
...
```bash
git clone https://github.com/Behangana/Diary_IQ.git
cd Diary_IQ
...
```text
https://github.com/Behangana/Diary_IQ
```
...
Developed by **[@Behangana](https://github.com/Behangana)**  
For inquiries: `emmanuelbeha@gmail.com`
